...
function HrDashboard() {
  ...
  return (
    <AppLayout>
      <PageHeader eyebrow="Human Resources" title="Today at a glance" description="A snapshot of your team. Calm, and current." />
      ...
      <div className="surface-card overflow-hidden">
        <SectionHeader title="Recently added" subtitle="The latest additions to your team" href="/employees" />
        {recent.length === 0 ? (
